...
%line                   </* #line %d "%s" */\r\n>
%include                <using %s;\r\n>
%include_file           <yy_token.cs>
%token                  <    public const int %s%-20s = %2d;\r\n>
%parse_name             <Parse>
...
%parse_func_suffix      <    }\r\n>
%type                   <byte,short,int,long,sbyte,short,int,long>
%symbol_num             <    const int  YY_NSYMBOL = %d;\r\n>
%state_num              <    const int  YY_NSTATE = %d;\r\n>
%rule_num               <    const int  YY_NRULE = %d;\r\n>
%accept_action          <    const int  YY_ACCEPT_ACTION = %d;\r\n>
%error_action           <    const int  YY_ERROR_ACTION = %d;\r\n>
%shift_default_offset   <    const int  YY_SHIFT_DEFAULT_OFFSET = %d;\r\n>
%reduce_default_offset  <    const int  YY_REDUCE_DEFAULT_OFFSET = %d;\r\n>
%minor_prefix           <\r\n    class YY_MINOR_TYPE{\r\n>
...
%rule_info_suffix       <    };\r\n>
%destructor_prefix      <class yy_destructor_%d : destructor{\r\n\
    /* destructor function */\r\n\
...
%reduce_prefix          <class yy_reduce_%d : reduce{\r\n\
    /* reduce function */\r\n\
